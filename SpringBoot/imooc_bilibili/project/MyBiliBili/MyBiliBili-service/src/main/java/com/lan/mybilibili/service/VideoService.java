...
import com.lan.mybilibili.dao.VideoDao;
import com.lan.mybilibili.domain.*;
import com.lan.mybilibili.domain.exception.ConditionException;
import com.lan.mybilibili.service.util.FastDFSUtil;
import com.lan.mybilibili.service.util.ImageUtil;
import com.lan.mybilibili.service.util.IpUtil;
...
public class VideoService {
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        com.lan.mybilibili.domain.File file = fileService.getFileByMd5(fileMd5);
