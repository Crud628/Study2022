...
import com.lan.springbootmall.model.dao.OrderItemMapper;
import com.lan.springbootmall.model.dao.OrderMapper;
import com.lan.springbootmall.model.dao.ProductMapper;
import com.lan.springbootmall.model.pojo.Order;
...
import com.lan.springbootmall.model.vo.OrderItemVO;
import com.lan.springbootmall.model.vo.OrderVO;
import com.lan.springbootmall.service.CartService;
import com.lan.springbootmall.service.OrderService;
import com.lan.springbootmall.service.UserService;
import com.lan.springbootmall.util.OrderCodeFactory;
import com.lan.springbootmall.util.QRCodeGenerator;
...
public class OrderServiceImpl implements OrderService {
    ...
    public String create(CreateOrderReq createOrderReq) {
        ...
        for (int i = 0; i < cartVOList.size(); i++) {
            ...
            if (cartVO.getSelected().equals(Constants.Cart.SELECTED)) {
        ...
        order.setOrderStatus(Constants.OrderStatusEnum.NOT_PAID.getCode());
        order.setPostage(0);
    ...
    private OrderVO getOrderVO(Order order) {
        ...
        orderVO.setOrderStatusName(Constants.OrderStatusEnum.codeOf(orderVO.getOrderStatus()).getValue());
        return orderVO;
    }
    ...
    public void cancel(String orderNo) {
        ...
        if (order.getOrderStatus().equals(Constants.OrderStatusEnum.NOT_PAID.getCode())) {
        ...
        try {
            QRCodeGenerator
                    .generateQRCodeImage(payUrl, 350, 350,
                            Constants.FILE_UPLOAD_DIR + orderNo + ".png");
    ...
    public void pay(String orderNo) {
        ...
        if (order.getOrderStatus() == Constants.OrderStatusEnum.NOT_PAID.getCode()) {
    ...
    public void deliver(String orderNo) {
        ...
        if (order.getOrderStatus() == Constants.OrderStatusEnum.PAID.getCode()) {
            order.setOrderStatus(Constants.OrderStatusEnum.DELIVERED.getCode());
    ...
    public void finish(String orderNo) {
        ...
        //发货后可以完结订单
        if (order.getOrderStatus() == Constants.OrderStatusEnum.DELIVERED.getCode()) {
